...
#job_name = args[1]
media_location = "audios/polly_generated_audio.pcm"
text_input = args[1] 
only_transcribe = args[2]
...
#change input text into pcm file
if os.path.exists(media_location):
    os.remove(media_location)
    print("input pcm file deleted successfully.")
else:
    print("input pcm file does not exist.")
polly_text_to_audio(media_location, text_input, 'pcm')
...
polly_text_to_audio(response_audio_filename, tigo_saying, 'mp3')
